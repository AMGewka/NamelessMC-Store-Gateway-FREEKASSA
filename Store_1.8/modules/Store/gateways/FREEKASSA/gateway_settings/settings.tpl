...
<div class="form-group"><label for="inputFREEKASSAadminemail">{$ADMIN_EMAIL}</label>
<input class="form-control" type="text" id="inputFREEKASSAadminemail" name="admin_email" value="{$ADMIN_EMAIL_VALUE}" placeholder="{$ADMIN_EMAIL}">
</div>
</div>
</div>
<br />
